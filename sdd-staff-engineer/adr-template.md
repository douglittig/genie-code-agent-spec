...
> Gerado pelo `@sdd-staff-engineer` na Fase 2 do fluxo de desenvolvimento.
...
| **Próximo passo** | `@sdd-po` — Stories/Tasks no Jira (sdd-doc documenta este ADR no Epic) |
...
> O `sdd-design` **não pode** alterar as decisões abaixo sem um novo ADR aprovado.
