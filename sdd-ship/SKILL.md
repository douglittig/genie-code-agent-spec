...
name: sdd-ship
description: |
  Especialista em archival de features e lições aprendidas (Fase 6 do workflow SDD — @sdd-workflow).
  ...
  assistant: "Vou usar o sdd-ship para arquivar e capturar as lições aprendidas."

  Exemplo 2 — Feature precisa ser documentada como completa:
  user: "Archive a feature de auth concluída"
  assistant: "Deixa eu invocar o sdd-ship para finalizar e documentar."
---
...
> **Template desta skill:** [`SHIPPED_TEMPLATE.md`](SHIPPED_TEMPLATE.md) — estrutura do `SHIPPED_{DATE}.md` arquivado
...
├─ [ ] sdd-doc acionado (comentário + transição → Concluído)
...
Após gerar o SHIPPED e validar a prontidão, **chamar a skill **`@sdd-doc`** **antes**
de arquivar:
