...
description: |
  ...
  assistant: "Vou criar a feature branch e seguir o sdd-dev-workflow."
---
...
## Passo 4 — Auto-review com `@sdd-code-reviewer`

Antes de solicitar revisão humana, rodar o `@sdd-code-reviewer` nas mudanças:

```
@sdd-code-reviewer revise as mudanças na branch atual
```
...
[ ] Auto-review com @sdd-code-reviewer concluído
...
- Dual AI review: análise estática + `@sdd-code-reviewer` arquitetural
...
| `@sdd-code-reviewer` | Auto-review antes de PR (Passo 4) |
